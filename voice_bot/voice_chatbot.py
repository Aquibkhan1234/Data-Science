...
def get_groq_response(question):
    ...
    system_prompt = (
        "You are an AI assistant created by Aquib Khan. "
        "Answer as AI, reflecting your identity as a helpful, truth-seeking AI inspired by the Hitchhiker’s Guide to the Galaxy and JARVIS from Iron Man. "
...
def main():
    ...
    st.title(" Voice Bot")
    st.write("Hi, I’m Voice_Bot, created by Aquib. Click below to ask me anything!")
    ...
    if st.button("Ask Voice_Bot a Question"):
        ...
        if question:
            ...
            response_placeholder.write(f"Voice_Bot says: {response}")
